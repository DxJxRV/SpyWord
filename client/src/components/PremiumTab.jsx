...
export default function PremiumTab() {
  ...
  // Mostrar solo la tab premium
  useEffect(() => {
    setCurrentTab(0); // Fijar siempre en la tab de NO ADS
  }, [isPremium]);

  const handleClick = () => {
    // Tab de Premium - Abrir modal
    setShowPricingModal(true);
    // Tab de Ruleta OCULTA - setShowRouletteModal(true);
  };
  ...
  return (
    <>
      <div className="fixed bottom-24 right-0 z-50">
        ...
        >
          {/* Tab de NO ADS (Premium) - Solo esta tab visible */}
